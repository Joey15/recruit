...
<body>
	...
	<div class="container summary">
		<h1 style="margin-left">发布招聘信息</h1>
	...
	<div class="container summary1">
		...
		<form action="addjob" method="post">
				...
				<ul style="list-style-type: none; font-size: 20px;">
					...
					<li class="li1">
						<label>企业名称:</label> 
						<input class="input2" type="text" name="fullname">
					</li>
					
					<li class="li1">
						<label>工作内容:</label> 
						<input class="input2" type="text" name="content">
					</li>
					...
					<li class="li1"><label>学历要求:</label> 
						...
						<select style="margin-left:50px;width:150px" name="degree">
					...
					<li class="li1"><label>薪资:</label> 
						<select style="margin-left:90px;width:150px" name="salary">
					...
					<li class="li1"><label>发布日期:</label> <input class="input2" type="text" id="email" name="date"></li>
